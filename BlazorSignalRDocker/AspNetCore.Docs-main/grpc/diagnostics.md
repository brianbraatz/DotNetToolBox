...
The gRPC client adds a [logging scope](BlazorSignalRDocker/AspNetCore.Docs-main/aspnetcore/fundamentals/logging/index.md#log-scopes) to logs made during a gRPC call. The scope has metadata related to the gRPC call:
